    ...
    "cells": [
        {
            ...
            "source": [
                ...
                "use SqlTraining\r\n",
                "\r\n",
                "CREATE TABLE Employee(Empid int identity(1234,1111),Name nvarchar(50),Department nvarchar(50),HireDate date,Training int);\r\n",
                ...
                "('C. Cole','Shipping', '05/18/1991',32),('E .Ellis','Sales', '07/15/1998',80),('F. Files','Advertising', '10/17/1990',24),('G. Gates','Advertising', '03/15/1999',48);\r\n",
                "\r\n",
                ...
                "update Employee set Location='Pune' where Empid=2345;\r\n",
                "update Employee set Location='Banglore' where Empid=3456;\r\n",
                "update Employee set Location='Pune' where Empid=4567;\r\n",
                "update Employee set Location='Banglore' where Empid=5678;\r\n",
                "update Employee set Location='Pune' where Empid=6789;\r\n",
                "update Employee set Location='Banglore' where Empid=7900;\r\n",
                "update Employee set Location='Delhi' where Empid=9011;\r\n",
                "update Employee set Location='Chennai' where Empid=10122;\r\n",
                "update Employee set Location='Indore' where Empid=11233;\r\n",
                "\r\n",
            ...
            "metadata": {
                "azdata_cell_guid": "5684078d-db02-4b48-a2f4-30e7699780c8"
            },
            "outputs": [],
